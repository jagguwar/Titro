...
import com.app.titro.components.PriorityItem
import com.app.titro.data.models.Priority
import com.app.titro.ui.theme.LARGE_PADDING
import com.app.titro.ui.theme.TOP_APP_BAR_HEIGHT
...
import com.app.titro.ui.theme.Typography
...
fun ListAppBar(
    ...
    when (searchAppBarState) {
        SearchAppBarState.CLOSED -> {
            DefaultListAppBar(
                onSearchClicked = { sharedViewModel.updateAppBarState(newState = SearchAppBarState.OPENED) },
                onSortClicked = { sharedViewModel.persistSortState(it) },
                onDeleteAllConfirmed = { sharedViewModel.updateAction(newAction = Action.DELETE_ALL) }
            )
        }
        else -> {
            SearchAppBar(
